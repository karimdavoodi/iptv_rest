...
BOOST_LOG_TRIVIAL(trace) << "Add route /launcher/default";
mux.handle("/launcher/default").get(launcher_default);
BOOST_LOG_TRIVIAL(trace) << "Add route /launcher/background";
mux.handle("/launcher/background").get(launcher_background);
